...
#adding grouping column
txt_JAPdf$grouping <- "G8"

```

Reading developing countries NDCs:
...
combined_NDC <- rbind(txt_USdf, txt_EUdf, txt_UKdf, txt_AUSdf, txt_KORdf, txt_CANdf, txt_JAPdf,
      txt_indiadf, txt_BANdf, txt_BRAdf, txt_EGPdf, txt_SUDdf, txt_SAdf, txt_TURdf, txt_IDNdf)
...
* The focus of G8 countries is on mitigation as countries like Canada, US, South Korea, and Japanhad GHG or carbin as their top 10 high frequency words. 
...
combined_NDC %>% 
  ...
  labs(y=NULL)
```
In the above chart we looked at the frequency of words in the combined G8 and G20-G8 countries. Based on the above chart, we make the following observations:
...
* G20-G8 countries also focus on sectors like water, waste and technology. These countries also mention words like capacity and support which means that these countries also focus on capacity building in the sector and need for support to achieve their goals.
* Sustainability and efficiency also gets mentioned a lot of times in G20-G8 countries NDCs. 
* On contrary, G8 countries do not have strong focus on any of these areas. They have high focus on GHG emissions, and reduction. Although both G* and G20-G8 have strong focus on energy sector. 
...
remove_words <- c("canada", "uk", "india", "uk’s", "canada’s", "uk’s", "africa", "korea", "indonesia", "africa’s", 
                  "bangladesh", "australia’s", "scotland", "brazil", "saudi", "australia", "canadian", "african",
                  "egypt", "korean", "turkey", "www.legislation.gov.uk", "egyptian", "canadians", "indonesia’s", 
                  "ireland", "korea’s", "india’s", "mw", "ha", "km", "gw", "eu's", "srn", "inr", "ccc", "alberta", "wales", "welsh", "scottish", "australian", "japan's", "inuit", "www.gov.scot",
                  "scotland's", "gn", "scp", "ec", "pcf", "www.gov.uk", "gba", "gpg")
